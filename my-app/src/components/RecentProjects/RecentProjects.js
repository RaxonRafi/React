              ...
              <Row>
                  <Col lg={4} md={6} sm={12} className="p-2">
                        <Card className="projectCard">
                            <Card.Img variant="top" src="https://reactjs-arnab-ff0301.netlify.app/static/media/projects.e993a071.jpg" />
                            <Card.Body>
                    ...
                    <Col lg={4} md={6} sm={12} className="p-2">
                        <Card className="projectCard">
                            ...
                            <Card.Body>
                             ...
                             <Link to='/projectdetails'><Button variant="primary">Details</Button></Link>                             </Card.Body>
                        </Card>
                  </Col>
